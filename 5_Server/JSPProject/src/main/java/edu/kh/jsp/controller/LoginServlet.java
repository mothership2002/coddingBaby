...
// 어떤 요청 주소를 처리할 지 지정(<servlet-mapping> 태그)
...
//		JSP란? -Servlet에 HTML 코드를 쓰는게 불편하기 때문에 
//		반대로 HTML코드에 Java코드를 쓸 수 있게 하는 문서
...
//							HttpServletRequest 객체 / HttpServletResonse 객체를
//							발송(위임)하는 역할의 객체 
		
//		req.getRequestDispatcher("JSP경로")
//		- HttpServletRequest 객체가 생성될 때 
//		내부에 자동으로 요청발송자(RequestDispatcher)가 가이 생성됨
...
//		JSP에게 전송될 예정인 req 객체에 result 변수 값을 담아서 같이 전달 
